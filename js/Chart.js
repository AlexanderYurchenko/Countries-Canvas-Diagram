...
window.Chart = function(context){
	...
	var Doughnut = function(data,config,ctx){
	  ...
	  function drawLargeDiag(ctx, data, diagParams){
	    ...
	    for (var i=0; i<data.length; i++){
	      drawTextAlongArc(ctx, data[i].value, diagParams[i].country, width/2, height/2, middleRadius, 0.045, i);
	    }

	    function drawTextAlongArc(context, valueNum, str, centerX, centerY, radius, angle, i){
	      context.save();
	      ...
	      textIcon.onload = function() {
	        ...
	        context.drawImage(textIcon, i*80, 0, 75, 60, -iconWidth/2, -28, 75, 60);
	        context.restore();
	      };
	  ...
	  drawLargeDiag(ctx, data, diagParams);
